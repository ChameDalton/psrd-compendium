...
// in pathfinder_athenaeum/test/mocks/database_helper.dart.
...
class MockDatabaseHelper extends _i1.Mock implements _i3.DatabaseHelper {
  ...
  @override
  _i4.Future<_i2.Database> getDatabase(String? dbName) => (super.noSuchMethod(
        Invocation.method(
          #getDatabase,
          [dbName],
        ),
  ...
  @override
  _i4.Future<List<Map<String, dynamic>>> getMenuItems({int? parentMenuId}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMenuItems,
          [],
