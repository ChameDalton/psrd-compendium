...
class MockDbWrangler extends _i1.Mock implements _i3.DbWrangler {
  ...
  @override
  _i4.Future<void> initializeDatabases(_i5.BuildContext? context) =>
      (super.noSuchMethod(
        Invocation.method(
          #initializeDatabases,
          [context],
  ...
  @override
  _i4.Future<List<Map<String, dynamic>>> getBookmarks() => (super.noSuchMethod(
        Invocation.method(
          #getBookmarks,
          [],
        ),
